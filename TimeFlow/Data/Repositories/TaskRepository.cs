...
namespace TimeFlow.Data.Repositories
{
    ...
    public class TaskRepository : BaseRepository
    {
        ...
        private void ValidateTask(TaskItem task, bool isUpdate = false)
        {
            ...
            {
                // Chi check qua khu khi tao moi, khi update co the de lai DueDate cu
            ...
            // Validate Description length (neu co)
        ...
        public bool CanUserEdit(int taskId, int userId)
        {
            ...
            // Neu la group task, check xem user co trong group khong
            if (task.IsGroupTask)
            {
        ...
        /// <summary>
        /// Tao task moi voi validation va transaction (improved version)
        /// </summary>
        public int Create(TaskItem task)
        {
            ...
            // Step 2: Create task trong transaction
        ...
        /// <summary>
        /// Cap nhat task voi authorization check va validation
        /// </summary>
        public bool Update(TaskItem task, int requestingUserId)
        {
            ...
            // Step 3: Update trong transaction
            return ExecuteInTransaction((conn, trans) =>
            {
        ...
        /// <summary>
        /// Cap nhat task (backward compatible - no auth check)
        /// </summary>
        ...
        /// <summary>
        /// Cap nhat status (backward compatible - no auth check)
        /// </summary>
        ...
        /// <summary>
        /// Xoa task voi cascade delete va transaction (NEW)
        /// </summary>
        public bool DeleteWithCascade(int taskId, int requestingUserId)
        {
            ...
            // Step 2: Get task info truoc khi xoa (de log)
            var task = GetById(taskId);
            if (task == null) return false;

            // Step 3: Delete trong transaction voi cascade
            return ExecuteInTransaction((conn, trans) =>
            {
                ...
                // Delete GroupTasks (neu la group task)
        ...
        /// <summary>
        /// Xoa task (backward compatible - no cascade, no auth check)
        /// </summary>
