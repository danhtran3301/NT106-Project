...
namespace TimeFlow
{
    ...
    public class TimeFlowColorButton : CustomPanel 
    {
        private Color _originalBackColor;
        private Color _hoverColor = ColorPalette.Gray200;
        private bool _isMouseDown = false;

        public TimeFlowColorButton()
        {
            this.Cursor = Cursors.Hand;
            this.SetStyle(ControlStyles.Selectable, true);
            this.TabStop = true;
            this.Text = "TimeFlowColorButton"; 
    ...
    public partial class FormTaskDetail : Form
    {
        ...
        private TimeFlowColorButton CreateMenuButton(string text, Color backColor, Color foreColor, int width, int height, Color? hoverColor) // ĐÃ SỬA KIỂU TRẢ VỀ
        {
            return new TimeFlowColorButton 
            {
                Text = text,
                BackColor = backColor,
                ForeColor = foreColor,
        ...
        private TimeFlowColorButton CreateMenuButton(string text, Color backColor, Color foreColor, int width, int height) // ĐÃ SỬA KIỂU TRẢ VỀ
        {
